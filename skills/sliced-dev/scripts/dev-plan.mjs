...
每个新的 TARGET 都创建独立 rules-review v6 run，并完整审查当前全部 reviewItems；不得引用旧 run 或继承旧 result。
...
- currentRunId：由本 TARGET 的全新 rules-review v6 run 返回后写回；package 不携带旧 runId。
