...
## 审计
- runId：run-fail-human-override-no-risk
- ruleSetId：RS001
...
- reviewItems：31
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-human-override-no-risk`
...
- humanOverride：requestedMode=single_batch，risk=未记录
