...
## 审计
- runId：run-fail-human-override-mode-mismatch
- ruleSetId：RS001
...
- reviewItems：31
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-human-override-mode-mismatch`
...
- humanOverride：requestedMode=multi_batch，risk=用户强制 single agent，可能降低大 diff review 覆盖质量。
