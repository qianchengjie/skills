...
## 审计
- runId：run-fail-required-rule-no-item
- ruleSetId：RS001
...
- reviewItems：2
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-required-rule-no-item`
...
- metrics：changedUnits=1，candidates=1，targets=2，requiredRuleRefs=2，reviewItems=2
