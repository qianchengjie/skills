...
## 审计
- runId：run-fail-concurrency-single-no-override
- ruleSetId：RS001
...
- reviewItems：3
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-concurrency-single-no-override`
...
- reason：用户要求并发，但错误保留 single_batch。
