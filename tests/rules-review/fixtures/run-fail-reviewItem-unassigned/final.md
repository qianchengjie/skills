...
## 审计
- runId：run-fail-reviewItem-unassigned
- ruleSetId：RS001
...
- reviewItems：3
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-reviewItem-unassigned`
