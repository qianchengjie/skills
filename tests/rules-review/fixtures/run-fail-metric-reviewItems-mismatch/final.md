...
## 审计
- runId：run-fail-metric-reviewItems-mismatch
- ruleSetId：RS001
...
- reviewItems：3
- reviewBatches：1
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-metric-reviewItems-mismatch`
...
- metrics：changedUnits=1，candidates=1，targets=2，requiredRuleRefs=2，reviewItems=999
