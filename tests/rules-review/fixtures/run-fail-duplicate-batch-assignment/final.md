...
## 审计
- runId：run-fail-duplicate-batch-assignment
- ruleSetId：RS001
...
- reviewItems：3
- reviewBatches：2
- 验证命令：`node skills/rules-review/scripts/validate.js --mode run --dir tests/rules-review/fixtures/run-fail-duplicate-batch-assignment`
...
- reason：reviewItems are split across multiple reviewBatches.
